 ...
 */
export function extractToolCallsFromMarkdown(text: string): ParsedFallbackToolCall[] {
  ...
  while ((match = blockRegex.exec(text)) !== null) {
    ...
    for (const candidate of candidates) {
      ...
      // refine guarantees at least one of tool/name is defined
 ...
 */
export function toInternalToolCalls(parsed: ParsedFallbackToolCall[]): ToolCall[] {
